...
// Pie
// 源码：https://github.com/GravityBox/GravityBox/blob/pie/GravityBox/src/main/java/com/ceco/pie/gravitybox/ModVolumeKeySkipTrack.java
object ModVolumeKeySkipTrackPie {
    ...
    private const val CLASS_WINDOW_MANAGER_FUNCS = "com.android.server.policy.WindowManagerPolicy.WindowManagerFuncs"
    ...
    private fun isMusicActive(): Boolean {
        ...
        // check remote
        try {
            return XposedHelpers.callMethod(am, "isMusicActiveRemotely") as Boolean
        } catch (t: Throwable) {
    ...
    private fun handleVolumeLongPress(phoneWindowManager: Any, keycode: Int) {
        ...
        val mVolumeUpLongPress = getAdditionalInstanceField(phoneWindowManager, "mVolumeUpLongPress") as Runnable
        val mVolumeDownLongPress = getAdditionalInstanceField(phoneWindowManager, "mVolumeDownLongPress") as Runnable
